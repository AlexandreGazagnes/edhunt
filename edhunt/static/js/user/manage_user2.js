...
function navManager(x){
    var array1 = ['resume', 'expectation', 'account', 'identification', 'localisation',
    'diploma', 'work_experience', 'work_status', 'language'];
...
$(function(){
    buttonManager('resume', 'expectation', 'account');
    buttonManager('identification', 'localisation', 'diploma');
    buttonManager('work_experience', 'work_status', 'language');    })


// $(function(){
//     $("#resumeButton").click(function(){
//         $("#resumeButton").removeClass('eTildehOn', 'eTildehOff').addClass('ehOn');
//         $("#expectationButton").removeClass('ehOn', 'ehOff').addClass('ehOff');
//         $("#accountButton").removeClass('ehOn', 'ehOff').addClass('ehOff'); })})


// $(function(){
//     $("#expectationButton").click(function(){
//         $("#resumeButton").removeClass('ehOn', 'ehOff').addClass('ehOff');
//         $("#expectationButton").removeClass('ehOn', 'ehOff').addClass('ehOn');
//         $("#accountButton").removeClass('ehOn', 'ehOff').addClass('ehOff'); })})
...
//         $("#resumeButton").removeClass('ehOn', 'ehOff').addClass('ehOff');
//         $("#expectationButton").removeClass('ehOn', 'ehOff').addClass('ehOff');
//         $("#accountButton").removeClass('ehOn', 'ehOff').addClass('ehOn'); })})
